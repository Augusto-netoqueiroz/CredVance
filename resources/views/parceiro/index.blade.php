            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($parceiros as $parceiro)
                    <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow hover:shadow-lg transition relative">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">Slug: <code>{{ $parceiro->slug }}</code></p>
                        ...
                        <div class="mt-3 flex space-x-2">
                            <a href="{{ route('parceiro.metrics', $parceiro) }}" class="text-xs bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">Métricas</a>
                ...
                @empty
                    <p class="text-gray-500 dark:text-gray-400">Nenhum link de parceiro disponível.</p>
                @endforelse
            </div>

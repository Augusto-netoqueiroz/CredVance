...
>
    <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md p-6">
        ...
        {{-- Botão Fechar posicionado corretamente no canto superior direito --}}
        <div class="absolute top-3 right-3">
            <button
                id="btnCloseModal"
                class="text-gray-800 dark:text-gray-200 hover:text-red-600 dark:hover:text-red-400 transition"
        ...
        {{-- Espaço superior reservado para o botão não sobrepor conteúdo --}}
        <div class="pt-8">

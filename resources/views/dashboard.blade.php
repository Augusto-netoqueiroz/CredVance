    ...
    <div class="py-10 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                ...
                <a href="{{ route('boleto.manage.form') }}" class="flex items-center justify-center bg-gradient-to-r from-green-500 to-green-700 hover:opacity-90 text-white font-medium py-3 rounded-xl shadow transition">Registrar Pagamento</a>
